...
interface QuizQuestion {
  id: number;
  question: string;
  managerTypeSignal: 'CAPITALIST' | 'DILUTER' | 'CAMOUFLAGER';
}
...
const quizQuestions: QuizQuestion[] = [
  // CAPITALIST questions (manipulation/pressure)
  {
    id: 1,
    question: "Using emotional manipulation to get what they want.",
    managerTypeSignal: 'CAPITALIST'
  },
  {
    id: 2,
        ...
        <div className="p-6">
          ...
          {step === 'detailed_info' && determinedManagerType && (
            <div className="text-center">
              ...
              {!['CAPITALIST', 'DILUTER', 'CAMOUFLAGER'].includes(determinedManagerType) && (
                <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-6 mb-6 border border-blue-200 dark:border-blue-800">
