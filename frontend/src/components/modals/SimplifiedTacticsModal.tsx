              ...
              <div>
                ...
                <div className="space-y-2">
                  {Object.entries(practiceData.tacticCounts).map(([tactic, count]) => {
                    const tacticType = getTacticTypeName(tactic);
                    const tacticColor = getTacticTypeColor(tactic);

                    return (
                      <div
                        key={tactic}
                        className="flex justify-between items-center bg-white/60 dark:bg-gray-800/60 rounded-lg p-3"
                      >
                        <div className="flex flex-col">
                          ...
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full mt-1 transition-colors duration-200 ${tacticColor}`}
                          >
                            {tacticType}
                          </span>
                        </div>
