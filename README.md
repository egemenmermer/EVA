...
### Landing Page
![EVA Landing Page](docs/images/EVA-5.png)
...
### Admin Dashboard
![Admin Dashboard](docs/images/EVA-6.png)
...
![Practice Session](docs/images/EVA-2.png)
...
### AI-Powered Feedback
![Detailed Feedback](docs/images/EVA-3.png)
...
![Tactics Guide](docs/images/EVA-1.png)
...
- **Different Manager Types**: Practice handling ethical issues with various manager personalities:
  - Capitalist: Managers who focus on making stakeholders happy and making good business choices
...
2. Ensure correct ports are configured (5001 for agent, 8080 for backend, 5173 for frontend)
