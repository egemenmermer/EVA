...
public class ManagerTypeQuizController {
    ...
    public ResponseEntity<ManagerTypeQuizResponseDTO> submitQuiz(
        ...
        try {
            ...
            managerTypeScores.put("CAPITALIST", 0);
            ...
            String determinedManagerType = "CAPITALIST"; // default
            int highestScore = managerTypeScores.get("CAPITALIST");
            ...
            if (highestScore == 0 || (managerTypeScores.get("CAPITALIST").equals(managerTypeScores.get("DILUTER")) 
                && managerTypeScores.get("DILUTER").equals(managerTypeScores.get("CAMOUFLAGER")))) {
                String[] types = {"CAPITALIST", "DILUTER", "CAMOUFLAGER"};
