    ...
    public ResponseEntity<PracticeSessionResponseDTO> getPracticeSession(
        ...
        try {
            ...
            PracticeSessionResponseDTO responseDTO = PracticeSessionResponseDTO.builder()
                    ...
                    .concern(session.getConcern())
                    .selectedChoices(
                        session.getSelectedChoices().stream()
                            .map(sel -> SelectionDataDTO.builder()
                                .choice(sel.getChoice())
                                .evs(sel.getEvs())
                                .tactic(sel.getTactic())
                                .tacticType(sel.getTacticType())
                                .build()
                            )
                            .toList()
                    )
