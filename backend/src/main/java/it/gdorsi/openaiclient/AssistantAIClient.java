...
public class AssistantAIClient {
    ...
    private String post(String url, Object body) throws Exception {
        ...
        System.out.println("➡️ POST " + url);
        System.out.println("➡️ Request body: " + jsonBody);
    
        HttpRequest request = getRequestWithHeaders(url)
    ...
    public ThreadResponseDTO createThread() throws Exception {
        String response = post(threadsUrl, Collections.emptyMap());
    ...
    private HttpRequest.Builder getRequestWithHeaders(String url) {
        return HttpRequest.newBuilder()
                ...
                .header("OpenAI-Beta", "assistants=v2") // <-- fix here
